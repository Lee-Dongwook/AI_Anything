...
class Settings(BaseSettings):
    ...
    architecture_allow_globs: str = Field(default="**/*", description="path globs allowed for generated patches")
    architecture_deny_globs: str = Field(default="", description="path globs forbidden for generated patches")
